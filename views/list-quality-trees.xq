...
<html>
  ...
  <body>
     ...
     <h2>References</h2>
     <a href="http://danmccreary.com/presentations/quality-trees.pptx">Excellent blog post by Chris Wallace</a> This proves
     that it will run on a prior version of eXist.<br/>
     <a href="http://www.dpawson.co.uk/graph2svg">Graph to SVG Documentation on Dave Pawson's Web Site</a><br/>
     <a href="http://code.google.com/p/graph2svg">Graph 2 SVG on Google Code</a><br/>
